...
| S1-02 CI en verde | **Pendiente** | Workflow escrito y con YAML válido; sus mismos comandos se ejecutaron en local (y los de migraciones contra PostgreSQL 16 real). Falta la ejecución en GitHub Actions: requiere subir el repositorio |
